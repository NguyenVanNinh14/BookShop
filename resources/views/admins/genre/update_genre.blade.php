...
<div class="container-fluid">
                        ...
                        <div class="card">
                            ...
                            <form action="{{route('edit-genre', $update['genre_id'])}}" method="POST">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-8 offset-sm-2">
                                        <div class="form-group ">
                                            <input type="hidden" class="form-control" name="genre_id" value="{{$update->genre_id}}" >

                                        </div>
                                        <div class="form-group ">
                                            <label class="control-label">Tên thể loại</label>
                                            <input type="text" class="form-control" name="genre_name" value="{{$update->genre_name}}" >
                                        ...
                                        <div class="form-row">
                                            <div class="col-sm-12">
                                                ...
                                                <button class="btn btn-gradient-success"><a style="color:white ;" href="{{route('genre')}}">Trở lại</a></button>
                                                    <button type="submit" name="edit_genre" class="btn btn-gradient-success">Sửa Thể loại</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
