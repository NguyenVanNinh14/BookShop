                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-center font-size-18">
                                                    <a href="{{route('update-author', $value['author_id'])}}" class="text-gray m-r-15"><i class="ti-pencil"></i></a>
                                                    <a onclick="return confirm('Bạn có chắc chắn sẽ xoá')" href="{{route('delete-author', $value['author_id'])}}" class="text-gray"><i class="ti-trash"></i></a>
                                                </td>
                                            </tr>
                                        </tbody>
                                        @endforeach
