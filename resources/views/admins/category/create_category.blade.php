...
<div class="container-fluid">
                        ...
                        <div class="card">
                            ...
                            <form action="{{route('create-category-product')}}" method="POST">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                        ...
                                        <div class="form-row">
                                            <div class="col-sm-12">
                                                ...
                                                <button class="btn btn-gradient-success"><a style="color:white ;" href="{{route('category')}}">Trở lại</a></button>
                                                    <button type="submit" name="create_category_product" class="btn btn-gradient-success">Thêm Danh mục</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
